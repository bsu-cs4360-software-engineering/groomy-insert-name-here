...
struct qt_meta_stringdata_CLASSCustomersENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCustomersENDCLASS = QtMocHelpers::stringData(
    "Customers",
    "onViewButtonClicked",
    "",
    "onEditButtonClicked",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCustomersENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Customers::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CLASSCustomersENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCustomersENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCustomersENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Customers::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCustomersENDCLASS.stringdata0))
